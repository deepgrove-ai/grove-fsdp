...
try:
    ...
    _select_min_cost_strategy = None
...
class ShardingPropagator(TorchShardingPropagator):
    ...
    def _select_strategy(
        ...
        if _select_min_cost_strategy is not None:
            return _select_min_cost_strategy(strategy, op_schema)
        return super()._select_strategy(strategy)
    ...
    def _wrap_output_spec_tensor_meta(
        ...
        if hasattr(self, "_create_output_spec_with_new_tensor_meta"):
    ...
    def propagate_op_sharding_non_cached(self, op_schema: OpSchema) -> OutputSharding:
        ...
        if op_schema.op in self.op_strategy_funcs:
            ...
            output_sharding.output_spec = self._wrap_output_spec_tensor_meta(
